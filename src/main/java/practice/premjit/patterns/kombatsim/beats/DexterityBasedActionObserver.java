...
/**
 * Most of the fighters have a rhythm with which they perform attacks in the
 * arena. To achieve this, observer pattern is used to beat to either a Tik or a
 * Tok ({@link TikTok}). Dexterity is an attribute which determines the agility
 * of the fighter. Based on dexterity, DexterityBasedActionObserver calculates
 * when the fighter performs an action.
 * 
