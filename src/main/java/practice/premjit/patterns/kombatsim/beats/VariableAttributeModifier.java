...
/**
 * Basic idea here is to enable regeneration of {@link VariableAttribute} over time. <p><ul>
 * <li>Can be temporary or permanent.
 * <li>If negative {@link VariableAttributeModifier#amountPerBeat amountPerBeat} is specified, instead of regenerate, 
 * it will degenerate.
