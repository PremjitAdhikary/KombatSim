...
/**
 * Most of the fighters have a rhythm. This rhythm determines how many actions
 * the fighter can react to. To achieve this, observer pattern is used to beat
 * to either a Tik or a Tok ({@link TikTok}). Dexterity is an attribute which
 * determines the agility of the fighter. Based on dexterity,
 * DexterityBasedReactionObserver calculates how many actions the fighter can
 * react to.
 * 
