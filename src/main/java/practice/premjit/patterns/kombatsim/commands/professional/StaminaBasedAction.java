...
/**
 * While Physical in nature, this can only be executed by {@link 
 * practice.premjit.patterns.kombatsim.fighters.Professional professionals} (who have the attribute stamina). The 
 * extent of damage is determined by the amount of stamina present. <p>
 * 
 * Note that every action has a cost (on stamina) associated with it. <p> 
 * 
