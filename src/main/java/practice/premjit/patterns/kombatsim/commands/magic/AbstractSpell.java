...
/**
 * AbstractSpell encapsulates the cool down logic for Spells. The idea is that
 * every Spell has a cool down associated with it. Once casted, it can only be
 * casted after the cool down {@link AbstractSpell#cooldownDuration duration} is
 * over.
 * <p>
 * 
 * This is achieved by {@link CooldownSwitch}.
 * <p>
 * 
 * AbstractSpell holds other common logic like:
 * <p>
 * <ul>
 * <li>Managing {@link AbstractSpell#manaCost manaCost} required for casting the
 * Spell.
