...
/**
 * Endure, a unique ReactionCommand for Batman, follows the Composite pattern to
 * incorporate elements of both
 * {@link practice.premjit.patterns.kombatsim.commands.physical.Block Block} and
 * {@link practice.premjit.patterns.kombatsim.commands.physical.Evade Evade}.
 * <p>
 * 
 * The idea is a vanilla batman, being vulnerable is more like to Evade the
 * attacks while equipped batman, being more strong, will Block the attacks.
 * <p>
 * 
 * After the first level of defense (Block or Evade) is done, in case the damage
 * is fatal, Batman uses his Mojo to hold on to his dear life.
 * <p>
 * 
