...
/**
 * Along with base damage, this renders the opponent powerless to act or react
 * for a certain duration. <br>
 * <br>
 * 
 * This it does by wrapping the original strategies of the opponent under a
 * flag. This flag is disabled for the duration of the shock and then its
 * enabled. <br>
 * <br>
 * 
 * In case there are overlapping Shock Damage, the shock duration lasts till the
 * last shock damage. So no stacking of damages here. <br>
 * <br>
 * 
