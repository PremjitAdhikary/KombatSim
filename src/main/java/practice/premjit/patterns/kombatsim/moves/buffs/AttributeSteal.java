...
/**
 * As the name suggests, this is a buff which will steal from a particular attribute of the affected fighter over time 
 * and transfer the same (as it is or after conversion) to the caster of the buff.
 * <p><ul>
 * <li>The buff is temporary.
 * <li>The buff only works on variable attributes.
 * <li>The buff adds two {@link VariableAttributeModifier}s, first to affect the fighter and second to affect the 
 * caster.
 * </ul>
 * 
