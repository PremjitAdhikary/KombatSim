...
/**
 * Base damage which affects the life of the opponent <p>
 * 
 * {@link #indirect} is to indicate if Damage is not direct from the attacker. For example, if Damage is reflected from 
 * Mages shield, this would be true.
 * 
