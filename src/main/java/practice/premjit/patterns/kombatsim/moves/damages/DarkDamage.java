...
/**
 * Along with base damage, this permanently deteriorates the primary attribute of the opponent. Point being, longer 
 * the fight, the weaker the opponent gets. <br><br>
 * 
