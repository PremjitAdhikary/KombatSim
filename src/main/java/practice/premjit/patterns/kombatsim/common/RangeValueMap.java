...
/**
 * Best to explain is through an example. Suppose we have to grade students according to their marks. We have the grades 
 * as follows: <p><ul>
 ...
 * </ul>
 * 
 * One way is to have a map of keys from 0-100 and corresponding grades as values. This is inefficient as there are lots 
 * of redundant values. <p>
 * 
 * RangeValueMap solves this problem by letting you add the lower value of the range and the corresponding data against 
 * it. So for the above, it would as simple as: <p><pre>
