...
/**
 * Weapon has the following characteristics:
 * <p>
 * <ul>
 * <li>Adds one or more additional actions of type {@link WeaponCommand}.
 * <li>The said actions can be used in conjunction with original set of actions
 * or the original set can be ignored. This can be set with
 * {@link #replaceFighterAttacks()}
 * <li>Has custom {@link ActionStrategy} implementation
 * {@link WeaponActionStrategy}.
 * <li>If replaceActions is true {@link WeaponActionStrategy} chooses among the
 * WeaponCommand. If not, there's a chance that the original ActionStrategy is
 * invoked for the original ActionCommands
 * </ul>
 * 
