...
/**
 * This is a special arena which has a restriction of time. The time can be set,
 * if not, it has default beats.
 * <p>
 * 
 * If by the time the fight ends, both the fighters are standing, winner is
 * decided by who has greater percentage of life remaining.
 * 
